        ...
        <?php foreach ($banner_utama as $b_u) : ?>
            <div class="col-lg-3">
                ...
                <div class="card mb-4">
                    ...
                    <a class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin');" href=" <?= base_url('admin/delete_thanks/') . $b_u['id']; ?>"><i class="fas fa-trash-alt"></i>Hapus</a>
                </div>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/thanks'); ?>" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="link" name="link" placeholder="Text">
                    </div>
