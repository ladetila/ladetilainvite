                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="collapse" id="collapseCardExample">
                        ...
                        <div class="card-body border-bottom-primary">
                            ...
                            <a class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin');" href=" <?= base_url('admin/delete_mundur/') . $hm['id']; ?>"><i class="fas fa-trash-alt"></i>Hapus</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/mundur'); ?>" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <p class="text-right">Contoh :<span class="text-info"> 2022 08 10</span></p>
                </div>
