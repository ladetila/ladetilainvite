        ...
        <?php foreach ($banner_1 as $b_1) : ?>
            <div class="col-lg-3">
                ...
                <div class="card mb-4">
                    ...
                    <a class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin');" href=" <?= base_url('admin/delete_hero_link/') . $b_1['id']; ?>"><i class="fas fa-trash-alt"></i>Hapus</a>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="tambahherolinkModalLabel">Tambah Hero Image</h5>
