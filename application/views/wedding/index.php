...
<section id="gla_content" class="gla_content">
    ...
    <section class="gla_section gla_image_bck" data-color="#fafafd">
        ...
        <?php foreach ($hero_judul as $hj) : ?>
            <div class="container text-center">
                <p><img src="<?= base_url('wedding-2/'); ?>images/animations/flowers2.gif" data-bottom-top="@src:<?= base_url('wedding-2/'); ?>images/animations/flowers2.gif; opacity:1" class="gla_animated_flower" height="150" alt=""></p>
                <h2><?= $hj['judul']; ?></h2>
    ...
    <?php foreach ($banner_1 as $b_1) : ?>
        <section class="gla_section gla_image_bck gla_fixed gla_wht_txt" data-stellar-background-ratio="0.8" data-image="<?= base_url('wedding-2/images/wedding/wedding-1/') . $b_1['image']; ?>">
            ...
            <!-- Over -->
            <div class="gla_over" data-color="#1e1d2d" data-opacity="0.0"></div>
    ...
    <section class="gla_section">
        ...
        <div class="container text-center">
            <?php foreach ($wedding_detail as $wd) : ?>
                <p><img src="<?= base_url('wedding-2/'); ?>images/animations/flowers4.gif" data-bottom-top="@src:<?= base_url('wedding-2/'); ?>images/animations/flowers4.gif; opacity:1" class="gla_animated_flower" height="110" alt=""></p>
                <h2><?= $wd['judul']; ?></h2>
    ...
    <?php foreach ($hero_image as $hi) : ?>
        <section class="gla_section gla_image_bck gla_fixed gla_wht_txt" data-stellar-background-ratio="0.2" data-image="<?= base_url('wedding-2/images/wedding/wedding-1/') . $hi['image']; ?>">
            ...
            <!-- Over -->
            <div class="gla_over" data-color="#1e1d2d" data-opacity="0.1"></div>

            <div class="container text-center">
                <p><img src="<?= base_url('wedding-2/'); ?>images/animations/rsvp.gif" data-bottom-top="@src:<?= base_url('wedding-2/'); ?>images/animations/rsvp.gif" height="200" alt=""></p>
    ...
    <section class="gla_section gla_image_bck" data-color="#fff">
        <div class="container text-center">
            <h2 style="font-family: Comic Sans MS">Sosial Media</h2>
            <div class="gla_portfolio_no_padding grid">
                <?php foreach ($social_media as $sm) : ?>
                    ...
                    <div class=" card shadow mb-3">
                        <center>
                            <a href="<?= $sm['sosmed']; ?>">
                                <i class="<?= $sm['icon']; ?>" style="font-size: 5em;">
                                </i>
                            </a>
                        </center>
                        <a href="<?= $sm['sosmed']; ?>" class="card shadow mb-4" <?= $sm['sosmed']; ?> </a>
                    </div>
            </div>
        <?php endforeach; ?>
    ...
    <?php foreach ($banner_utama as $b_u) : ?>
        <section class="gla_section gla_image_bck gla_fixed gla_wht_txt" data-stellar-background-ratio="0.8" data-image="<?= base_url('wedding-2/images/wedding/wedding-1/thanks/') . $b_u['image']; ?>">
            ...
            <div class="container text-center">
                <p><img src="<?= base_url('wedding-2/'); ?>images/animations/thnyou.gif" alt="" height="200" data-bottom-top="@src:<?= base_url('wedding-2/'); ?>images/animations/thnyou.gif"></p>
                <h3><?= $b_u['link']; ?></h3>
